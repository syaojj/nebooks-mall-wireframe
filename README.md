...
NE Books 개편 기능 정의서_v1.0_260617 (Sheet 01·02·03·06·07·09·10)을 기준으로 작성한 기획 검토용 Front 와이어프레임입니다.

## 버전 (별도 접근)

| 버전 | 설명 | 진입 |
|---|---|---|
| **v1.0** | 흑백/회색톤 기본 와이어프레임 (구조 검토용) | [`wireframe_v1.0/index.html`](wireframe_v1.0/index.html) |
| **v2.0** | NE Design.md v0.11.5-alpha 적용 retrofit | [`wireframe_v2.0/index.html`](wireframe_v2.0/index.html) |
...
## 화면 (Front 11종)
메인 · 교재목록 · 교재상세 · 학습자료실 · 장바구니 · 주문/결제 · 결제완료 · 마이페이지(주문내역/포인트/쿠폰) · 1:1문의
